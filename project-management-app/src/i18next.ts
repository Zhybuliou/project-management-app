  ...
  resources: {
    en: {
      translation: {
        ...
        nameInputRequired: 'Name must contain at least 2 letters',
        nameInputRequired2: 'Name must contain only letters',
        signUp: 'sign up',
        signOut: 'sign out',
    ...
    ru: {
      translation: {
        ...
        nameInputRequired: 'Имя должно содержать не менее 2 букв',
        nameInputRequired2: 'Имя должно содержать только буквы',
